...
$packagesQuery = $conn->prepare("SELECT * FROM packages WHERE category_type='Culture' AND status IN (1,2) ORDER BY FIELD(package_category,'Budget','Mid-Range','Premium')");
...
<body>
    ...
    <section class="hero d-flex flex-column" style="background-image: url('images/culturemain5.jpg');">
